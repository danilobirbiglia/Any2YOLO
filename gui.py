...
class Any2YOLOApp:
    ...
    def _setup_gui(self):
        ...
        logo_image = Image.open("any2yolo.ico")
    ...
    def _setup_header(self):
        ...
        logo_image = Image.open("any2yolo.ico").resize((50, 50), Image.Resampling.LANCZOS)
        self.header_logo = ImageTk.PhotoImage(logo_image)
    ...
    def _view_logs(self):
        ...
        log_text.insert(tk.END, open("converter.log").read())
    ...
    def _about_app(self):
        ...
        about_window.iconbitmap("any2yolo.ico")
